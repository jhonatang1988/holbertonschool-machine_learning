...
and has early_stopping, and use inverse_time_decay for learning rate, and now
...
def train_model(network, data, labels, batch_size, epochs,
    ...
    :param save_best: a boolean indicating whether to save the model after each
    epoch if it is the best.  a model is considered the best if its validation
    ...
    if filepath and save_best is True:
        if not callbacks:
            callbacks = []
